...
class XMLCoderTests: XCTestCase {
    ...
    struct Arrays : AWSShape {
       public static var _encoding: [AWSMemberEncoding] = [
            .collection(key: "ArrayOfNatives", encoding: .list(member: "member"))
       ]
    ...
    struct Dictionaries : AWSShape {
       public static var _encoding: [AWSMemberEncoding] = [
           .collection(key: "natives", encoding: .map(entry: "entry", key: "key", value: "value")),
           .collection(key: "shapes", encoding: .flatMap(key: "key", value: "value"))
       ]
    ...
    func testDecodeExpandedContainers() {
        struct Shape : AWSShape {
            static let _encoding: [AWSMemberEncoding] = [
                .collection(key: "array", encoding:.list(member: "member")),
                .collection(key: "dictionary", encoding:.map(entry: "entry", key: "key", value: "value"))
            ]
            let array : [Int]
    ...
    func testArrayEncodingDecodeEncode() {
        struct Shape : AWSShape {
            static let _encoding: [AWSMemberEncoding] = [.collection(key: "array", encoding:.list(member: "member"))]
            let array : [Int]
        }
    ...
    func testDictionaryEncodingDecodeEncode() {
        struct Shape : AWSShape {
            static let _encoding: [AWSMemberEncoding] = [.collection(key: "d", encoding:.map(entry:"item", key: "key", value: "value"))]
            let d : [String:Int]
        }
    ...
    func testFlatDictionaryEncodingDecodeEncode() {
        struct Shape : AWSShape {
            static let _encoding: [AWSMemberEncoding] = [.collection(key: "d", encoding:.flatMap(key: "key", value: "value"))]
            let d : [String:Int]
        }
    ...
    func testEnumShapeDictionaryEncodingDecodeEncode() {
        ...
        struct Shape : AWSShape {
            static let _encoding: [AWSMemberEncoding] = [.collection(key: "d", encoding:.map(entry:"item", key: "k", value: "v"))]
